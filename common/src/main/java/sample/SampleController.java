...
public class SampleController {
	 ...
	 * http://localhost:8080/common/sample/
	...
	/**
	 * http://localhost:8080/common/sample/getVocTypeList
	 * 사용시 제이슨 필요
	 * 
	 * @return
	 * @throws Exception
	...
	/**
	 * 컨트롤러에 매핑된 모든 메서드들이 호출될 때마다 반복적으로 실행되므로 효율성을 고려해야 한다.
	 * requestScope 부분에서 출력됨
	 * 
	 * @return
	 */
