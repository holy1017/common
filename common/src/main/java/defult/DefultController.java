...
public class DefultController {
	...
	private static final Logger logger = LoggerFactory.getLogger(DefultController.class);
	protected Log log = LogFactory.getLog(DefultController.class); 
	...
	public String Defult(Locale locale, Model model) {
		...
		logger.info("Defult 서블릿 실행. 로컬: {}.", locale);
